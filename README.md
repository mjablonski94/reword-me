...
more professional, or steered by your own instruction - then replaces it in place. Bring your own
API key (Claude, ChatGPT, Gemini, Mistral, Grok, DeepSeek) or run fully local and free with
Ollama. No accounts, no tracking.
...
| **Windows** | [`kmp/`](kmp/) | Kotlin Multiplatform, Compose Desktop | In development |
